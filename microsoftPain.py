...
class MainWindow(QMainWindow):
    ...
    def testScene1(self):
        ...
        self.drawingWidget.drawing.add_shape(Rectangle(50, 50, 50, 50, QColor('purple'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Circle(400, 300, 100, QColor('green'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Circle(200, 400, 120, QColor('blue'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Star(600, 300, 8, 50, 100, QColor('yellow'), QColor('black')))
        self.drawingWidget.update()

    def testScene2(self):
        self.drawingWidget.drawing = Drawing()
        self.drawingWidget.drawing.add_shape(Rectangle(50, 50, 100, 200, QColor('light blue'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Rectangle(200, 200, 150, 100, QColor('light yellow'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Star(300, 100, 7, 50, 100, QColor('pink'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Circle(200, 400, 70, QColor('light green'), QColor('black')))
        self.drawingWidget.drawing.add_shape(Circle(500, 200, 60, QColor('lavender'), QColor('black')))
        self.drawingWidget.update()
